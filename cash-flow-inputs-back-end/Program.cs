...
using CashFlowInputs.API.Configurations;
...
builder.Services.AddScoped<ICashFlowInputRepository, CashFlowInputRepository>();
builder.Services.AddScoped<ICashFlowInputService, CashFlowInputService>();
